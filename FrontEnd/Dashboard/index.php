...
<?php } else {}?>
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">WELCOME TO DASHBOARD</h1>
    </div>
    ...
    <div class="products-area-wrapper gridView">
      <div class="products-header">
        ...
        $sql="SELECT sub_name,subject_id, class_section, t3.id AS KAKA FROM subjects t1 inner join course t2 on t1.id = t2.subject_id inner join class t3 on t3.id =t2.class_id inner join users t4 on t4.id=t2.teacher_id WHERE t4.id = $u_id " ;
...
?>
      ...
      <a href="attendancerecord.php?subject_val=<?php echo $subject_value?>&class_val=<?php echo $class_val?>">
      <form action="attendancerecord.php" method="POST">
     
        <div class="product-cell category"><span class="cell-label">Subject:</span><?php  echo $row['sub_name']?> </div>
        <div class="product-cell sales"><span class="cell-label">Class:</span> <?php  echo $row['class_section']?></div>
        <input type="submit" value = "" class="cell-more-button">  
      </form>
      </div>  
        </a>
      <?php } ?>  
